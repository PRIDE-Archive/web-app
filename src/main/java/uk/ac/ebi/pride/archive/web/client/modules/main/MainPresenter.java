package uk.ac.ebi.pride.archive.web.client.modules.main;

import com.google.gwt.user.client.ui.AcceptsOneWidget;
import com.google.web.bindery.event.shared.EventBus;
import uk.ac.ebi.pride.archive.web.client.events.state.EmptyViewEvent;
import uk.ac.ebi.pride.archive.web.client.events.state.InvalidStateEvent;
import uk.ac.ebi.pride.archive.web.client.events.state.LoadingDataEvent;
import uk.ac.ebi.pride.archive.web.client.events.state.ValidStateEvent;
import uk.ac.ebi.pride.archive.web.client.events.updates.ErrorOnUpdateEvent;
