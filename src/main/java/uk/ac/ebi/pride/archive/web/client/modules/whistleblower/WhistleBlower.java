package uk.ac.ebi.pride.archive.web.client.modules.whistleblower;
...
public class WhistleBlower implements StateChangingActionEvent.Handler,
    ...
    private static Logger logger = Logger.getLogger(WhistleBlower.class.getName());
    ...
    public void onStateChangingActionEvent(StateChangingActionEvent event) {
        ...
        logger.finer("(Whistler):   " + getIndentation() + evName +
                "(\"" + vType.replace("\n", " ") + "\")" + " <- " + clName);
