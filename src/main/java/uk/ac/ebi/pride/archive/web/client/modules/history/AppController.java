package uk.ac.ebi.pride.archive.web.client.modules.history;
...
import uk.ac.ebi.pride.archive.web.client.events.requests.GroupRequestEvent;
import uk.ac.ebi.pride.archive.web.client.events.requests.PeptideRequestEvent;
import uk.ac.ebi.pride.archive.web.client.events.requests.ProteinRequestEvent;
import uk.ac.ebi.pride.archive.web.client.events.state.*;
import uk.ac.ebi.pride.archive.web.client.events.updates.*;
...
//                    if(sequence.equals(match.getSequence()) && (position == -1 || position == match.getPosition())) {    // ARCHIVE CHANGE
                    if(sequence.equals(match.getId()) && (position == -1 || position == match.getPosition())) {
