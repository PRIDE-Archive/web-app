...
import uk.ac.ebi.pride.archive.web.client.utils.DefaultHashMap;
...
//            proteinIds.add(prot.getAccession());  // ARCHIVE CHANGE
...
//            peptideIds.add(match.getSequence() + State.sepFields + match.getPosition()); // ARCHIVE CHANGE
            peptideIds.add(match.getId() + State.sepFields + match.getPosition());
        }
